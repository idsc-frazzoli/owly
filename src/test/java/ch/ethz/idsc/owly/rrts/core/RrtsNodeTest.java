...
public class RrtsNodeTest extends TestCase {
  public void testSome() {
    ...
    RrtsNode n2 = n1.connectTo(Tensors.vector(2), RealScalar.of(1));
    RrtsNode n4 = n2.connectTo(Tensors.vector(4), RealScalar.of(2));
    RrtsNode n3 = n1.connectTo(Tensors.vector(3), RealScalar.of(4));
