...
public class DomainQueueTest extends TestCase {
  public void testQueue() {
    ...
    dq.add(GlcNodes.of(null, null, RealScalar.of(1), RealScalar.ZERO));
    dq.add(GlcNodes.of(null, null, RealScalar.of(0), RealScalar.ZERO));
    dq.add(GlcNodes.of(null, null, RealScalar.of(9), RealScalar.ZERO));
    GlcNode n1 = dq.poll();
