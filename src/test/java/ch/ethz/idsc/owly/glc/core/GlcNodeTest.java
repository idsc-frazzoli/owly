...
public class GlcNodeTest extends TestCase {
  public void testCompare() {
    ...
    GlcNode test1 = GlcNodes.of(null, state1, cost1, heuristic1);
    GlcNode test2 = GlcNodes.of(null, state1, cost1, heuristic1);
    ...
    GlcNode test3 = GlcNodes.of(null, state1, cost2, heuristic1);
    // assertFalse(test1.equals(test3));
    // Nodes are different in state ==> different
    GlcNode test4 = GlcNodes.of(null, state2, cost1, heuristic1);
