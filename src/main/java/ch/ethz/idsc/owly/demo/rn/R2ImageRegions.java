...
public enum R2ImageRegions {
  ...
  public static ImageRegion outside_0b36() {
    ...
    return transpose(charImage.getBufferedImage(), Tensors.vector(7, 7), false);
  }
  ...
  public static ImageRegion inside_0b36() {
    ...
    return transpose(charImage.getBufferedImage(), Tensors.vector(6, 7), false);
  }
  ...
  public static ImageRegion inside_2182() {
    ...
    return transpose(charImage.getBufferedImage(), Tensors.vector(9, 6), false);
  }
  ...
  public static ImageRegion inside_0f5c() {
    ...
    return transpose(charImage.getBufferedImage(), Tensors.vector(20, 10), false);
  }
}
