...
public class Se2ConstrainedShadowDemo extends Se2CarDemo {
  ...
  void configure(OwlyAnimationFrame owlyAnimationFrame) {
    ...
    ImageRegion imageRegionCar = //
        ImageRegions.loadFromRepository("/scenarios/multiarea.png", range, 1, false);
    ImageRegion imageRegionPed = //
        ImageRegions.loadFromRepository("/scenarios/multiarea.png", range, 2, false);
    BufferedImage image = null;
    try {
      image = ImageIO.read(getClass().getClassLoader().getResource("scenarios/multiarea.png"));
    ...
    ImageRender imgRender = ImageRender.of(image,  range);
