...
public class R2xTEllipsoidsAnimationDemo implements DemoInterface {
  ...
  public void start() {
    ...
    ContinuousNoiseUtils.wrap1D(SimplexContinuousNoise.FUNCTION, RealScalar.of(0));
    ContinuousNoiseUtils.wrap1DTensor(SimplexContinuousNoise.FUNCTION, Tensors.vector(1, 2, 3));
